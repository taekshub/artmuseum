...
<html lang="en">
  ...
  <!-- START: section -->
  <section class="probootstrap-intro" style="background-image: url(img/서울시립미술관_본관.jpg);" data-stellar-background-ratio="0.5">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-7 probootstrap-intro-text">
          <h1 class="probootstrap-animate">Art museum 미술관</h1>
          <div class="probootstrap-subtitle probootstrap-animate">
            <h2>서울시립미술관 본관의 전경 <a href="http://sema.seoul.go.kr" target="_blank">(링크)</a></h2>
          </div>
          <p class="watch-intro probootstrap-animate">
               <a href="https://www.youtube.com/watch?v=tjwA4YvI_ho" class="popup-vimeo">
              Watch the video <i class="icon-play2"></i></a></p>
        </div>
      </div>
    </div>
