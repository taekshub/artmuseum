          ...
          <label class="col-sm-3 control-label" for="inputEmail">이름</label>
	        <div class="col-sm-6">
	         	<input class="form-control" id="inputEmail" 
		           name="username" type="text" placeholder="이름을 입력하세요">
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label" for="inputPassword">전화번호</label>
	        <div class="col-sm-6">
	          ...
	          name="mobile" type="text" placeholder="전화번호를 입력하세요">
	        
	        </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12 text-center">
            <button id="btnIdFind" class="btn btn-primary" type="submit">아이디 찾기<i class="fa fa-times spaceLeft"></i></button>
...
$(function(){
	$("#btnIdFind").click(function(event){
	    ...
	    $("#myform").submit(function(event){
	    	...
	    	$("#myform").prop("action", 
	    	'<c:url value="/member/idfind_proc.mt"/>');
	    });
	});
	...
	$("#btnPwdFind").click(function(event){
		...
		//submit 기능 막고 
		location.href="${commonURL}/member/pwdfind.mt";
	});
	
	$("#btnLogon").click(function(event){
		event.preventDefault();
		location.href="${commonURL}/member/logon.mt";
	});
});
