	...
	<div id="section">
		...
		<div id="content">
			...
			<div class="bvc">
				...
				<dl class="files">
					<dt>첨부파일</dt>
					<dd><a href="<%=commonURL%>/down.mt?id=board&filename=<%=viewDto.getFilename1()%>"><%=viewDto.getFilename1()%></a></dd>
					<dd><a href="<%=commonURL%>/down.mt?id=board&filename=<%=viewDto.getFilename2()%>"><%=viewDto.getFilename2()%></a></dd>
					<dd><a href="<%=commonURL%>/down.mt?id=board&filename=<%=viewDto.getFilename3()%>"><%=viewDto.getFilename3()%></a></dd>
				</dl>
			</div>
			<!-- bbs view content E -->
